import uuid
import enum
from sqlalchemy import Column, DateTime, Enum, ForeignKey, Integer, UUID, String, UniqueConstraint, func
...
class Stock(Base):
    ...
    __table_args__ = (
        UniqueConstraint("product_id", "warehouse_id", name="unique_product_by_warehouse"),
    )
...
class Operation(Base):
    ...
    operation_type = Column(Enum(OperationType), nullable=False, default=OperationType.LOAD)
